...
- [ ] **Session history / replay** — partly built: the summary page shows the final board, but as a static thumbnail. `docs/SPEC.md` asks for a "View canvas" toggle that pans and zooms over the snapshot read-only.
